...
public sealed class OrdemServicoSalvarResolucaoRequest
{
    public string ResolucaoHtml { get; set; } = string.Empty;
}

public sealed class OrdemServicoSalvarResolucaoResponse
{
